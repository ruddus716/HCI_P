...
var Main = function () {
    ...
    var setColorScheme = function () {
        $('.icons-color a').bind('click', function () {
            ...
            $('#skin_color').attr("href", "assets/css/theme_" + $(this).attr('id') + ".min.css");
    ...
    var activeMenu = function () {
        ...
        $(".nav li a").each(function () {
            if ($(this).attr("href") == pgurl || $(this).attr("href") == '') {
                ...
                $(this).parent().addClass("active").closest('ul').parent().addClass("active");

                var a = $(this).parent().closest('ul').parent().parent().parent().parent().parent().closest('ul').parent();
                if (a.hasClass("mega-menu")) {
                    a.addClass("active");
                    //-- demo only
