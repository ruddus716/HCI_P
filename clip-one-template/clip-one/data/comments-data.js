...
function init() {
   //mysql get by php
      $.ajax(
         {
           type: 'GET',
           url: "php/review_load.php",
           dataType: "json",
           success: function (data, status, xhr) {
             console.log(data);
             for (var i = 0; i < Object.keys(data).length; i++) {//json length
                commentsArray.push(data[i]);
             }
   ...
   commentsArray.push({
      "id": 11,
      "parent": 0,
      "created": "2019-12-13T12:46:23.534Z",
      "modified": "2019-12-13T12:46:23.534Z",
      "content": "Quisque ligula eros ullamcorper quis, lacinia quis facilisis sed sapien. Mauris varius diam vitae arcu. Sed arcu lectus auctor vitae, consectetuer et venenatis eget velit.",
      "creator": 1,
      "fullname": "경연",
      "created_by_admin": false,
   ...
   //{ "id": 4, "parent": 0, "created": "2019-12-13T13:47:18.608Z", "modified": "2019-12-13T13:47:18.608Z", "content": "teste", "creator": 1, "fullname": "You", "profile_picture_url": "https:\/\/viima-app.s3.amazonaws.com\/media\/public\/defaults\/user-icon.png", "created_by_admin": false, "created_by_current_user": false, "upvote_count": 0, "user_has_upvoted": false, "is_new": false }
